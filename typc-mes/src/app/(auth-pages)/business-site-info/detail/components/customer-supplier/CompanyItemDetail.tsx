...
import { FaPlus, FaTrash, FaUpload, FaChevronRight } from 'react-icons/fa';
...
interface CompanyItemDetailProps {
  ...
  onInputChange: (field: keyof CompanyItem, value: string) => void;
            ...
            {items.map((item) => (
              ...
              >
                <div className='flex-1 truncate'>
                  ...
                  {item.transportation && (
                    <p className='text-xs text-gray-500 mt-1 truncate'>{item.transportation}</p>
                  )}
                </div>
            ...
            <div className='p-4'>
              ...
              <div className='space-y-4'>
                ...
                <div>
                  ...
                  >
                    {selectedItem.transportation || '운송수단을 선택하세요'}
                  </div>
                </div>
