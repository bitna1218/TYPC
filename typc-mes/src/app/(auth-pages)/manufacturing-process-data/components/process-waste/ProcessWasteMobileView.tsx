...
interface ProcessWasteMobileViewProps {
...
const ProcessWasteMobileView: React.FC<ProcessWasteMobileViewProps> = ({
  processWasteData,
  unitProcesses,
  units,
              ...
              >
                <div className='flex-1'>
                  <h3 className='font-medium text-gray-800'>
                    {item.wasteName || '(폐가스명 미입력)'}
                  </h3>
                  <div className='text-xs text-gray-500 mt-0.5'>
                    <span>
                      총 {item.totalAmount.toLocaleString()} {selectedUnit}
                    </span>
                  </div>
                </div>
                <div className='flex items-center space-x-2'>
                  <button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      onDeleteProcessWasteItem(item.id);
                    }}
...
export default ProcessWasteMobileView;
