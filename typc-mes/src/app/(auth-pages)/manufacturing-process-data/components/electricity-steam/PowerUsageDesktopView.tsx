...
interface PowerUsageDesktopViewProps {
...
const PowerUsageDesktopView: React.FC<PowerUsageDesktopViewProps> = ({
  powerUsageData,
  measurementData,
  correctionData,
  powerTypesForUsage,
      ...
      <div className='mb-8 p-1'>
        <div className='flex justify-between items-center mb-3'>
          <h3 className='text-lg font-semibold text-gray-800 flex items-center'>
            (2) 건물/공정/세부공정/설비 전력 계측값
            <Tooltip text='실제 계측된 전력량 데이터를 입력합니다. 이 값은 (1)번 사업장 사용량과 (3)번 보정값 계산에 사용됩니다.'>
...
export default PowerUsageDesktopView;
