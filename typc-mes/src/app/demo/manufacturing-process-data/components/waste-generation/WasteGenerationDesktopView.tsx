...
interface WasteGenerationDesktopViewProps {
  wasteData: WasteItem[];
...
const WasteGenerationDesktopView: React.FC<WasteGenerationDesktopViewProps> = ({
  wasteData,
  wasteTypes,
  treatmentMethods,
  unitProcesses,
...
export default WasteGenerationDesktopView;
