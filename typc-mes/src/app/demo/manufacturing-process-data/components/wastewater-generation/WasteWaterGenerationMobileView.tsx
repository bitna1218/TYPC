...
interface WasteWaterGenerationMobileViewProps {
...
const WasteWaterGenerationMobileView: React.FC<WasteWaterGenerationMobileViewProps> = ({
  wasteWaterData,
  wasteWaterTypes,
  treatmentMethods,
  unitProcesses,
    ...
    <div>
      ...
      <div className='space-y-4'>
        {wasteWaterData.map((item) => {
          ...
          const selectedWasteWaterType = getSelectedLabel(
            item.wasteWaterType,
            wasteWaterTypes
          );
          const selectedTreatmentMethod = getSelectedLabel(
              ...
              >
                <div className='flex-1'>
                  <h3 className='font-medium text-gray-800'>
                    {item.wasteWaterName || '(폐수명 미입력)'}
                  </h3>
                  <div className='text-xs text-gray-500 mt-0.5'>
                    {selectedWasteWaterType && (
                      <span className='mr-2'>{selectedWasteWaterType}</span>
                    )}
                    {selectedTreatmentMethod && (
                      <span className='mr-2'>{selectedTreatmentMethod}</span>
                    )}
                ...
                <div className='flex items-center space-x-2'>
                  <button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      onDeleteWasteWaterItem(item.id);
                    }}
...
export default WasteWaterGenerationMobileView; 