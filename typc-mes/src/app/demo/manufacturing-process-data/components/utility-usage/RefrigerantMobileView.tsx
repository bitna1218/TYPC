...
import { RefrigerantItem } from './RefrigerantDesktopView';

interface RefrigerantMobileViewProps {
...
const RefrigerantMobileView: React.FC<RefrigerantMobileViewProps> = ({
  resourceData,
  resourceTypes,
  unitProcesses,
  resourceLabel = '냉매',
...
export default RefrigerantMobileView; 