...
interface IndustrialGasMobileFormProps {
  item: IndustrialGasUtility;
  onInputChange: (
    id: number,
    field: keyof IndustrialGasUtility,
...
const IndustrialGasMobileForm: React.FC<IndustrialGasMobileFormProps> = ({
  item,
  onInputChange,
  onFileChange,
  onDelete,
    ...
    >
      ...
      >
        <h4 className='text-md font-medium text-gray-800'>
          {item.materialName || `산업용 가스 ${item.id}`}
        </h4>
        {isSelected ? (
        ...
        <div className='mt-3 space-y-3'>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleLocalInputChange('casNumber', e.target.value)
              }
              className='w-full p-2 border border-gray-300 rounded-md text-sm'
...
export default IndustrialGasMobileForm;
