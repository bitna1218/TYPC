...
export default function Header() {
  ...
  const selectedProgram = storeProgram;

  const { allCorpYearListResponse } = useCorpYear();

  const selectedYear = allCorpYearListResponse?.result?.content.find(
    (year) => year.id === idCorpYear,
  )?.year;
